...
if ($objSession->activa()) {
  ...
  $objRol = new C_Rol();
  $menuArray = $objMenuRol->menuesByIdRol($objSession->getVista());
    ...
    <div class="container-fluid">
      ...
      <div class="collapse navbar-collapse" id="navbarsExample03">
        <ul class="navbar-nav me-auto mb-2 m-2 mb-sm-0">
          <li><a href="../../index.php" role="button" class="px-2 mx-1 btn btn-lg " style="color:white">Home</a></li>
          <?php
          foreach ($menuArray as $objMenu) {
            if ($objMenu->getMeDeshabilitado() == NULL) {
          ?>
              <li><a href='<?php echo $objMenu->getMeDescripcion() ?>' role="button" class="px-2 mx-1 btn btn-lg" style="color:white"><?php echo $objMenu->getMeNombre() ?></a></li>
          <?php
            }
          }
          ?>
