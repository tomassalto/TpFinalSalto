                    ...
                    <div class="container col-md-10 text-white mt-5">
                        ...
                        <table class="container table table-dark table-hover">
                            ...
                            if ($arrayComprasRealiazadas != null) {
                                ...
                                ';
                                if($compraRealizada->getCompraEstadoTipo()->getIdCompraEstadoTipo() != 5){
                                    echo '
                                    ...
                                    echo '
                                    <td class="text-center"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-x-circle" viewBox="0 0 16 16">
