...
?>
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <form method="POST" action="modificarPermisos.php">
                                            ...
                                            <button type="submit" class="ms-3 my-1 text-decoration-none btn btn-outline-warning"> MODIFICAR </button>
        ...
        <div class="container-md w-50 text-center rounded p-3 mb-2 bg-dark text-white my-5 mb-5">
            <form class="row justify-content-center needs-validation" id="formNuevoPermiso" method="POST" action="../Accion/nuevoPermiso.php" novalidate>
                <div class="col-10">
                    <h5>Agregar Nuevo Permiso</h5>
                </div>
                <div class="col-lg-7 col-12 mt-2">
                    <label>Nombre Menú </label>
                    <input type="text" pattern="[a-zA-Z]+\s?[a-zA-Z]*\s?[a-zA-Z]*\s?[a-zA-Z]*\s?[a-zA-Z]*" name="meNombre" minlength="3" class="form-control text mt-2" required>
                ...
                <div class="col-lg-7 col-12 mt-2">
                    ...
                    <input type="text" pattern="(..\/)([a-zA-Z0-9_\-]+)(\/[a-zA-Z0-9_\-]+)\.php" name="meDescripcion" minlength="10" class="form-control text mt-2" required>
                    <div class="invalid-feedback">
                ...
                <div class="col-10">
                    <button class="btn btn-lg btn-success my-3 mt-4" type="submit" id="nuevoPermiso">AGREGAR
                    </button>
                </div>
            </form>
        </div>
