            ...
            <div class="modal-body p-5 pt-0">
                <form class="col needs-validation" method="post" action="../Accion/accionIniciarSesion.php" novalidate>
                    <div class="form-floating mb-3">
                        <input type="text" class="form-control" id="nombre" name="usNombre" required placeholder="Usuario">
                    ...
                    <div class="form-floating mb-3">
                        <input type="password" class="form-control" id="contraseña" required placeholder="Password">
